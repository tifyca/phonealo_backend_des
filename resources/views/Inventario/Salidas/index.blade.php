...
@section('titulo', 'Inventario - Salidas')
@section('descripcion', '')
      ...
      <div class="tile-body ">
        <div class="col mb-3 text-center">
          <div class="row ">
            ...
            <form class="row d-flex justify-content-end" action="{{route('salidas.index')}}" method="get"> 
            ...
            <div class="form-group col-md-2">
              ...
              <input class="form-control" type="date" id="desde" name="desde" data-date-format="DD/MM/YYYY"  >
            </div>
            <div class="form-group col-md-2">
              
              <input class="form-control" type="date" id="hasta" name="hasta" data-date-format="DD/MM/YYYY"  >
            </div>
