          ...
          <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <select class="form-control" id="id_fuente" name="id_fuente" disabled>
                   ...
                   <div class="form-group col-md-2">
                      ...
                      <select class="form-control" id="divisa_gasto" name="divisa_gasto" disabled>
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input class="form-control" type="text" id="cambio_gasto" name="cambio_gasto" value="{{$gastos->cambio}}"readonly>
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input class="form-control" type="text" id="comprobante_gasto" name="comprobante_gasto" value="{{$gastos->comprobante}}" readonly maxlength="32">
                    </div>
                    
                                  
                    <div class="form-group col-md-4">
                      <label for="importe_gasto">Importe</label>
                      <input class="form-control" type="text" id="importe_gasto" name="importe_gasto" value="{{$gastos->importe}}" readonly>
                    </div>      
